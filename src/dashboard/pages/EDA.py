...
online = False if (Path(__file__).parents[3] / "data").is_dir() else True
...
st.markdown(
    ...
    Melakukan proses EDA untuk mencari informasi lebih dalam terhadap data Twitter yang telah di 
    scrape menggunakan library `snscrape`.
